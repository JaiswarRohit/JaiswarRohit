...
- **DSA** - Solving algorithmic challenges

### 🌱 Interests & Learning
- **MLOps & MLflow** - End-to-end ML pipeline automation and deployment
- **High-Frequency Trading (HFT)** - Algorithmic trading systems
- **MERN Stack** - Full-stack web development
- **Python & React** - Expanding my development toolkit
...
- MLOps pipelines
- Trading algorithms
- Web applications with FastAPI, Django, MERN stack

### 📫 Let's Connect
- **Email**: [rjrohit1306@gmail.com](mailto:rjrohit1306@gmail.com)
- **LinkedIn**: [jaiswarrohit](https://www.linkedin.com/in/jaiswarrohit)
- **Twitter**: [@rohit_jaiswar01](https://twitter.com/rohit_jaiswar01)
- **Resume**: [View Here](https://drive.google.com/file/d/1cXpT9AI6hFG1qsdWJXs4faONlTIfo77-/view?usp=sharing)

### 📊 GitHub Stats

<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=JaiswarRohit&theme=tokyonight&hide_border=true" alt="GitHub Streak" />
</p>
...
⭐️ From [JaiswarRohit](https://github.com/JaiswarRohit)
